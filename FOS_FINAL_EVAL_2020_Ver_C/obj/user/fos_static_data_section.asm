...
{	
  ...
  800046:	e8 2f 02 00 00       	call   80027a <atomic_cprintf>
...
libmain(int argc, char **argv)
{
  ...
  800057:	e8 1c 10 00 00       	call   801078 <sys_getenvindex>
  ...
  80006d:	8d 0c 85 00 00 00 00 	lea    0x0(,%eax,4),%ecx
  ...
  800090:	8a 80 f0 ee 00 00    	mov    0xeef0(%eax),%al
  800096:	84 c0                	test   %al,%al
  800098:	74 0f                	je     8000a9 <libmain+0x58>
		binaryname = myEnv->prog_name;
  80009a:	a1 20 20 80 00       	mov    0x802020,%eax
  80009f:	05 f0 ee 00 00       	add    $0xeef0,%eax
  ...
  8000ad:	7e 0a                	jle    8000b9 <libmain+0x68>
		binaryname = argv[0];
  ...
  80013b:	68 04 19 80 00       	push   $0x801904
