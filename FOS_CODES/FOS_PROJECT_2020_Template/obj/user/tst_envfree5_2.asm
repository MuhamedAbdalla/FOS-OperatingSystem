...
void _main(void)
{
  ...
  80004a:	e8 75 14 00 00       	call   8014c4 <smalloc>
  ...
  80005e:	e8 da 17 00 00       	call   80183d <sys_calculate_free_frames>
  800063:	89 45 f0             	mov    %eax,-0x10(%ebp)
	int usedDiskPages_before = sys_pf_calculate_allocated_pages() ;
  800066:	e8 55 18 00 00       	call   8018c0 <sys_pf_calculate_allocated_pages>
  ...
  80008a:	68 a3 20 80 00       	push   $0x8020a3
  80008f:	e8 fe 19 00 00       	call   801a92 <sys_create_env>
  ...
  8000a3:	68 ac 20 80 00       	push   $0x8020ac
  8000a8:	e8 e5 19 00 00       	call   801a92 <sys_create_env>
  ...
  8000b9:	e8 f2 19 00 00       	call   801ab0 <sys_run_env>
  8000be:	83 c4 10             	add    $0x10,%esp
	env_sleep(15000);
  8000c1:	83 ec 0c             	sub    $0xc,%esp
  8000c4:	68 98 3a 00 00       	push   $0x3a98
  8000c9:	e8 60 1c 00 00       	call   801d2e <env_sleep>
  8000ce:	83 c4 10             	add    $0x10,%esp
	sys_run_env(envIdProcessB);
  8000d1:	83 ec 0c             	sub    $0xc,%esp
  8000d4:	ff 75 e4             	pushl  -0x1c(%ebp)
  8000d7:	e8 d4 19 00 00       	call   801ab0 <sys_run_env>
  ...
  8000ea:	e8 4e 17 00 00       	call   80183d <sys_calculate_free_frames>
  8000ef:	83 ec 08             	sub    $0x8,%esp
  8000f2:	50                   	push   %eax
  8000f3:	68 b8 20 80 00       	push   $0x8020b8
  ...
  800106:	e8 c1 19 00 00       	call   801acc <sys_free_env>
  80010b:	83 c4 10             	add    $0x10,%esp
	sys_free_env(envIdProcessB);
  80010e:	83 ec 0c             	sub    $0xc,%esp
  800111:	ff 75 e4             	pushl  -0x1c(%ebp)
  800114:	e8 b3 19 00 00       	call   801acc <sys_free_env>
  800119:	83 c4 10             	add    $0x10,%esp

	//Checking the number of frames after killing the created environments
	int freeFrames_after = sys_calculate_free_frames() ;
  80011c:	e8 1c 17 00 00       	call   80183d <sys_calculate_free_frames>
  800121:	89 45 e0             	mov    %eax,-0x20(%ebp)
	int usedDiskPages_after = sys_pf_calculate_allocated_pages() ;
  800124:	e8 97 17 00 00       	call   8018c0 <sys_pf_calculate_allocated_pages>
  ...
  80013a:	68 ec 20 80 00       	push   $0x8020ec
  80013f:	e8 24 04 00 00       	call   800568 <cprintf>
  800144:	83 c4 10             	add    $0x10,%esp
				freeFrames_after);
		panic("env_free() does not work correctly... check it again.");
  800147:	83 ec 04             	sub    $0x4,%esp
  80014a:	68 3c 21 80 00       	push   $0x80213c
  80014f:	6a 23                	push   $0x23
  800151:	68 72 21 80 00       	push   $0x802172
...
libmain(int argc, char **argv)
{
  ...
  800187:	e8 e6 15 00 00       	call   801772 <sys_getenvindex>
  ...
  800204:	e8 04 17 00 00       	call   80190d <sys_disable_interrupt>
	cprintf("**************************************\n");
  800209:	83 ec 0c             	sub    $0xc,%esp
  80020c:	68 4c 22 80 00       	push   $0x80224c
  ...
  800232:	52                   	push   %edx
  800233:	50                   	push   %eax
  800234:	68 74 22 80 00       	push   $0x802274
  ...
  80025a:	52                   	push   %edx
  80025b:	50                   	push   %eax
  80025c:	68 9c 22 80 00       	push   $0x80229c
  ...
  800277:	50                   	push   %eax
  800278:	68 dd 22 80 00       	push   $0x8022dd
  80027d:	e8 e6 02 00 00       	call   800568 <cprintf>
  800282:	83 c4 10             	add    $0x10,%esp
	cprintf("**************************************\n");
  800285:	83 ec 0c             	sub    $0xc,%esp
  800288:	68 4c 22 80 00       	push   $0x80224c
  80028d:	e8 d6 02 00 00       	call   800568 <cprintf>
  800292:	83 c4 10             	add    $0x10,%esp
	sys_enable_interrupt();
  800295:	e8 8d 16 00 00       	call   801927 <sys_enable_interrupt>
...
destroy(void)
{
  ...
  8002ad:	e8 8c 14 00 00       	call   80173e <sys_env_destroy>
...
exit(void)
{
  ...
  8002bb:	83 ec 08             	sub    $0x8,%esp
	sys_env_exit();
  8002be:	e8 e1 14 00 00       	call   8017a4 <sys_env_exit>
}
  8002c3:	90                   	nop
  8002c4:	c9                   	leave  
  8002c5:	c3                   	ret    
...
_panic(const char *file, int line, const char *fmt,...)
{
  ...
  8002e6:	50                   	push   %eax
  8002e7:	68 f4 22 80 00       	push   $0x8022f4
  ...
  8002ff:	50                   	push   %eax
  800300:	68 f9 22 80 00       	push   $0x8022f9
  ...
  800324:	68 15 23 80 00       	push   $0x802315
...
void CheckWSWithoutLastIndex(uint32 *expectedPages, int arraySize)
{
  ...
  800350:	68 18 23 80 00       	push   $0x802318
  800355:	6a 26                	push   $0x26
  800357:	68 64 23 80 00       	push   $0x802364
  ...
  800416:	68 70 23 80 00       	push   $0x802370
  80041b:	6a 3a                	push   $0x3a
  80041d:	68 64 23 80 00       	push   $0x802364
  ...
  800480:	68 c4 23 80 00       	push   $0x8023c4
  800485:	6a 44                	push   $0x44
  800487:	68 64 23 80 00       	push   $0x802364
...
static void putch(int ch, struct printbuf *b) {
  ...
  8004d8:	51                   	push   %ecx
  8004d9:	52                   	push   %edx
  8004da:	e8 1d 12 00 00       	call   8016fc <sys_cputs>
...
int vcprintf(const char *fmt, va_list ap) {
  ...
  800550:	50                   	push   %eax
  800551:	e8 a6 11 00 00       	call   8016fc <sys_cputs>
...
int atomic_cprintf(const char *fmt, ...) {
  ...
  800598:	83 ec 18             	sub    $0x18,%esp
	sys_disable_interrupt();
  80059b:	e8 6d 13 00 00       	call   80190d <sys_disable_interrupt>
	va_list ap;
	int cnt;
  ...
  8005b8:	89 45 f0             	mov    %eax,-0x10(%ebp)
	...
	sys_enable_interrupt();
  8005bb:	e8 67 13 00 00       	call   801927 <sys_enable_interrupt>
	return cnt;
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800605:	e8 da 17 00 00       	call   801de4 <__udivdi3>
  ...
  800653:	52                   	push   %edx
  800654:	50                   	push   %eax
  800655:	e8 9a 18 00 00       	call   801ef4 <__umoddi3>
  80065a:	83 c4 10             	add    $0x10,%esp
  80065d:	05 34 26 80 00       	add    $0x802634,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8007b0:	8b 04 85 58 26 80 00 	mov    0x802658(,%eax,4),%eax
  ...
  800891:	8b 34 9d a0 24 80 00 	mov    0x8024a0(,%ebx,4),%esi
  800898:	85 f6                	test   %esi,%esi
  80089a:	75 19                	jne    8008b5 <vprintfmt+0x173>
				printfmt(putch, putdat, "error %d", err);
  80089c:	53                   	push   %ebx
  80089d:	68 45 26 80 00       	push   $0x802645
  ...
  8008b0:	e9 49 02 00 00       	jmp    800afe <vprintfmt+0x3bc>
			...
			if (err > MAXERROR || (p = error_string[err]) == NULL)
				...
				printfmt(putch, putdat, "%s", p);
  8008b5:	56                   	push   %esi
  8008b6:	68 4e 26 80 00       	push   $0x80264e
  ...
  8008e1:	75 05                	jne    8008e8 <vprintfmt+0x1a6>
				p = "(null)";
  8008e3:	be 51 26 80 00       	mov    $0x802651,%esi
			if (width > 0 && padc != '-')
...
void* malloc(uint32 size)
{
  ...
  8012f5:	83 ec 28             	sub    $0x28,%esp
	...
	if(FirstTimeFlag)
  8012f8:	a1 04 30 80 00       	mov    0x803004,%eax
  8012fd:	85 c0                	test   %eax,%eax
  8012ff:	74 0f                	je     801310 <malloc+0x1e>
	{
		initialize_buddy();
  801301:	e8 a4 02 00 00       	call   8015aa <initialize_buddy>
		FirstTimeFlag = 0;
  801306:	c7 05 04 30 80 00 00 	movl   $0x0,0x803004
  80130d:	00 00 00 
	}
	//TODO: [PROJECT 2020 - [2] User Heap] malloc() [User Side]
	// Write your code here, remove the panic and write your code
	if(size > PAGE_SIZE / 2) {
  801310:	81 7d 08 00 08 00 00 	cmpl   $0x800,0x8(%ebp)
  801317:	0f 86 0b 01 00 00    	jbe    801428 <malloc+0x136>
  ...
  80132f:	25 ff 0f 00 00       	and    $0xfff,%eax
  801334:	85 c0                	test   %eax,%eax
  801336:	74 07                	je     80133f <malloc+0x4d>
  801338:	b8 01 00 00 00       	mov    $0x1,%eax
  80133d:	eb 05                	jmp    801344 <malloc+0x52>
  80133f:	b8 00 00 00 00       	mov    $0x0,%eax
  801344:	01 d0                	add    %edx,%eax
  801346:	89 45 e8             	mov    %eax,-0x18(%ebp)
  801349:	c7 45 f0 ff ff ff ff 	movl   $0xffffffff,-0x10(%ebp)
  801350:	c7 45 ec 01 00 00 00 	movl   $0x1,-0x14(%ebp)
		for(i = 0; i < MAXN; i++) {
  801357:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  80135e:	eb 5c                	jmp    8013bc <malloc+0xca>
			if(allocated[i] != 0) continue;
  801360:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801363:	8b 04 85 20 31 80 00 	mov    0x803120(,%eax,4),%eax
  80136a:	85 c0                	test   %eax,%eax
  80136c:	75 4a                	jne    8013b8 <malloc+0xc6>
			j = 1;
  80136e:	c7 45 ec 01 00 00 00 	movl   $0x1,-0x14(%ebp)
			i++;
  801375:	ff 45 f4             	incl   -0xc(%ebp)
			while(i < MAXN && allocated[i] == 0 && j < sizeToPage) {
  801378:	eb 06                	jmp    801380 <malloc+0x8e>
				i++;
  80137a:	ff 45 f4             	incl   -0xc(%ebp)
				j++;
  80137d:	ff 45 ec             	incl   -0x14(%ebp)
		int i = 0, sizeToPage = (size / PAGE_SIZE) + (size % PAGE_SIZE != 0 ? 1 : 0), indx = -1, j = 1;
		for(i = 0; i < MAXN; i++) {
			if(allocated[i] != 0) continue;
			j = 1;
  ...
  801383:	3d ff ff 01 00       	cmp    $0x1ffff,%eax
  801388:	77 16                	ja     8013a0 <malloc+0xae>
  80138a:	8b 45 f4             	mov    -0xc(%ebp),%eax
  80138d:	8b 04 85 20 31 80 00 	mov    0x803120(,%eax,4),%eax
  801394:	85 c0                	test   %eax,%eax
  801396:	75 08                	jne    8013a0 <malloc+0xae>
  801398:	8b 45 ec             	mov    -0x14(%ebp),%eax
  80139b:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  80139e:	7c da                	jl     80137a <malloc+0x88>
				i++;
				j++;
			}
			if(j == sizeToPage) {
  8013a0:	8b 45 ec             	mov    -0x14(%ebp),%eax
  8013a3:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  8013a6:	75 0b                	jne    8013b3 <malloc+0xc1>
				indx = i - j;
  8013a8:	8b 45 f4             	mov    -0xc(%ebp),%eax
  8013ab:	2b 45 ec             	sub    -0x14(%ebp),%eax
  8013ae:	89 45 f0             	mov    %eax,-0x10(%ebp)
				break;
  8013b1:	eb 13                	jmp    8013c6 <malloc+0xd4>
			}
			i--;
  8013b3:	ff 4d f4             	decl   -0xc(%ebp)
  8013b6:	eb 01                	jmp    8013b9 <malloc+0xc7>
	//TODO: [PROJECT 2020 - [2] User Heap] malloc() [User Side]
	// Write your code here, remove the panic and write your code
	if(size > PAGE_SIZE / 2) {
		int i = 0, sizeToPage = (size / PAGE_SIZE) + (size % PAGE_SIZE != 0 ? 1 : 0), indx = -1, j = 1;
  ...
  8013b8:	90                   	nop
	...
	if(size > PAGE_SIZE / 2) {
		int i = 0, sizeToPage = (size / PAGE_SIZE) + (size % PAGE_SIZE != 0 ? 1 : 0), indx = -1, j = 1;
		for(i = 0; i < MAXN; i++) {
  8013b9:	ff 45 f4             	incl   -0xc(%ebp)
  8013bc:	8b 45 f4             	mov    -0xc(%ebp),%eax
  8013bf:	3d ff ff 01 00       	cmp    $0x1ffff,%eax
  8013c4:	76 9a                	jbe    801360 <malloc+0x6e>
				indx = i - j;
				break;
			}
			i--;
		...
		if(indx == -1) {
  8013c6:	83 7d f0 ff          	cmpl   $0xffffffff,-0x10(%ebp)
  8013ca:	75 07                	jne    8013d3 <malloc+0xe1>
			return NULL;
  8013cc:	b8 00 00 00 00       	mov    $0x0,%eax
  8013d1:	eb 5a                	jmp    80142d <malloc+0x13b>
		}
		i = indx;
  8013d3:	8b 45 f0             	mov    -0x10(%ebp),%eax
  8013d6:	89 45 f4             	mov    %eax,-0xc(%ebp)
		while(i < j + indx) {
  8013d9:	eb 13                	jmp    8013ee <malloc+0xfc>
			allocated[i++] = j;
...
void free(void* virtual_address)
{
  ...
  801438:	89 45 ec             	mov    %eax,-0x14(%ebp)
  80143b:	8b 45 ec             	mov    -0x14(%ebp),%eax
  80143e:	25 00 f0 ff ff       	and    $0xfffff000,%eax
  801443:	89 45 08             	mov    %eax,0x8(%ebp)
	int size = 0, indx = ((uint32)virtual_address - USER_HEAP_START) / PAGE_SIZE;
  801446:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  80144d:	8b 45 08             	mov    0x8(%ebp),%eax
  801450:	05 00 00 00 80       	add    $0x80000000,%eax
  ...
  80145e:	8b 04 85 20 31 80 00 	mov    0x803120(,%eax,4),%eax
  801465:	89 45 e8             	mov    %eax,-0x18(%ebp)
	size = allocated[indx];
  801468:	8b 45 f0             	mov    -0x10(%ebp),%eax
  80146b:	8b 04 85 20 31 80 00 	mov    0x803120(,%eax,4),%eax
  801472:	89 45 f4             	mov    %eax,-0xc(%ebp)
	while(size > 0) {
  801475:	eb 17                	jmp    80148e <free+0x5f>
		allocated[indx++] = 0;
  801477:	8b 45 f0             	mov    -0x10(%ebp),%eax
  80147a:	8d 50 01             	lea    0x1(%eax),%edx
  80147d:	89 55 f0             	mov    %edx,-0x10(%ebp)
  801480:	c7 04 85 20 31 80 00 	movl   $0x0,0x803120(,%eax,4)
  801487:	00 00 00 00 
		size--;
  80148b:	ff 4d f4             	decl   -0xc(%ebp)
	// Write your code here, remove the panic and write your code
	virtual_address = ROUNDDOWN(virtual_address, PAGE_SIZE);
	int size = 0, indx = ((uint32)virtual_address - USER_HEAP_START) / PAGE_SIZE;
	int removable_size = allocated[indx];
	size = allocated[indx];
	while(size > 0) {
  80148e:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
  801492:	7f e3                	jg     801477 <free+0x48>
		allocated[indx++] = 0;
		size--;
	}
	sys_freeMem((uint32)virtual_address, removable_size);
  801494:	8b 55 e8             	mov    -0x18(%ebp),%edx
  801497:	8b 45 08             	mov    0x8(%ebp),%eax
  80149a:	83 ec 08             	sub    $0x8,%esp
  80149d:	52                   	push   %edx
  80149e:	50                   	push   %eax
  80149f:	e8 e4 03 00 00       	call   801888 <sys_freeMem>
...
void *realloc(void *virtual_address, uint32 new_size)
{
  ...
  8014b3:	68 b0 27 80 00       	push   $0x8027b0
  8014b8:	6a 7a                	push   $0x7a
  8014ba:	68 d6 27 80 00       	push   $0x8027d6
  8014bf:	e8 02 ee ff ff       	call   8002c6 <_panic>
...
void* smalloc(char *sharedVarName, uint32 size, uint8 isWritable)
{
  ...
  8014cd:	88 45 f4             	mov    %al,-0xc(%ebp)
	panic("this function is not required...!!");
  8014d0:	83 ec 04             	sub    $0x4,%esp
  8014d3:	68 e4 27 80 00       	push   $0x8027e4
  8014d8:	68 84 00 00 00       	push   $0x84
  8014dd:	68 d6 27 80 00       	push   $0x8027d6
  8014e2:	e8 df ed ff ff       	call   8002c6 <_panic>
...
void* sget(int32 ownerEnvID, char *sharedVarName)
{
  ...
  8014f0:	68 e4 27 80 00       	push   $0x8027e4
  8014f5:	68 8a 00 00 00       	push   $0x8a
  8014fa:	68 d6 27 80 00       	push   $0x8027d6
  8014ff:	e8 c2 ed ff ff       	call   8002c6 <_panic>
...
void sfree(void* virtual_address)
{
  ...
  80150d:	68 e4 27 80 00       	push   $0x8027e4
  801512:	68 90 00 00 00       	push   $0x90
  801517:	68 d6 27 80 00       	push   $0x8027d6
  80151c:	e8 a5 ed ff ff       	call   8002c6 <_panic>
...
void expand(uint32 newSize)
{
  ...
  80152a:	68 e4 27 80 00       	push   $0x8027e4
  80152f:	68 95 00 00 00       	push   $0x95
  801534:	68 d6 27 80 00       	push   $0x8027d6
  801539:	e8 88 ed ff ff       	call   8002c6 <_panic>
...
void shrink(uint32 newSize)
{
  ...
  801547:	68 e4 27 80 00       	push   $0x8027e4
  80154c:	68 99 00 00 00       	push   $0x99
  801551:	68 d6 27 80 00       	push   $0x8027d6
  801556:	e8 6b ed ff ff       	call   8002c6 <_panic>
...
void freeHeap(void* virtual_address)
{
  ...
  801564:	68 e4 27 80 00       	push   $0x8027e4
  801569:	68 9e 00 00 00       	push   $0x9e
  80156e:	68 d6 27 80 00       	push   $0x8027d6
  801573:	e8 4e ed ff ff       	call   8002c6 <_panic>

00801578 <ClearNodeData>:
...
void ClearNodeData(struct BuddyNode* node)
{
  ...
  80157e:	c6 40 11 00          	movb   $0x0,0x11(%eax)
	node->status = FREE;
  801582:	8b 45 08             	mov    0x8(%ebp),%eax
  801585:	c6 40 10 00          	movb   $0x0,0x10(%eax)
	node->va = 0;
  801589:	8b 45 08             	mov    0x8(%ebp),%eax
  80158c:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
	node->parent = NULL;
  801593:	8b 45 08             	mov    0x8(%ebp),%eax
  801596:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
	node->myBuddy = NULL;
  80159d:	8b 45 08             	mov    0x8(%ebp),%eax
  8015a0:	c7 40 14 00 00 00 00 	movl   $0x0,0x14(%eax)
}
  8015a7:	90                   	nop
  8015a8:	5d                   	pop    %ebp
  8015a9:	c3                   	ret    

008015aa <initialize_buddy>:
...
void initialize_buddy()
{
  ...
  8015b7:	e9 b7 00 00 00       	jmp    801673 <initialize_buddy+0xc9>
	{
		LIST_INSERT_HEAD(&BuddyFreeNodesList, &(FreeNodes[i]));
  8015bc:	8b 15 04 31 80 00    	mov    0x803104,%edx
  8015c2:	8b 4d fc             	mov    -0x4(%ebp),%ecx
  8015c5:	89 c8                	mov    %ecx,%eax
  8015c7:	01 c0                	add    %eax,%eax
  8015c9:	01 c8                	add    %ecx,%eax
  8015cb:	c1 e0 03             	shl    $0x3,%eax
  8015ce:	05 20 31 88 00       	add    $0x883120,%eax
  ...
  8015e1:	05 20 31 88 00       	add    $0x883120,%eax
  8015e6:	8b 00                	mov    (%eax),%eax
  8015e8:	85 c0                	test   %eax,%eax
  8015ea:	74 1c                	je     801608 <initialize_buddy+0x5e>
  8015ec:	8b 15 04 31 80 00    	mov    0x803104,%edx
  8015f2:	8b 4d fc             	mov    -0x4(%ebp),%ecx
  8015f5:	89 c8                	mov    %ecx,%eax
  8015f7:	01 c0                	add    %eax,%eax
  8015f9:	01 c8                	add    %ecx,%eax
  8015fb:	c1 e0 03             	shl    $0x3,%eax
  8015fe:	05 20 31 88 00       	add    $0x883120,%eax
  801603:	89 42 04             	mov    %eax,0x4(%edx)
  801606:	eb 16                	jmp    80161e <initialize_buddy+0x74>
  801608:	8b 55 fc             	mov    -0x4(%ebp),%edx
  80160b:	89 d0                	mov    %edx,%eax
  80160d:	01 c0                	add    %eax,%eax
  80160f:	01 d0                	add    %edx,%eax
  801611:	c1 e0 03             	shl    $0x3,%eax
  801614:	05 20 31 88 00       	add    $0x883120,%eax
  801619:	a3 08 31 80 00       	mov    %eax,0x803108
  80161e:	8b 55 fc             	mov    -0x4(%ebp),%edx
  801621:	89 d0                	mov    %edx,%eax
  801623:	01 c0                	add    %eax,%eax
  801625:	01 d0                	add    %edx,%eax
  801627:	c1 e0 03             	shl    $0x3,%eax
  80162a:	05 20 31 88 00       	add    $0x883120,%eax
  80162f:	a3 04 31 80 00       	mov    %eax,0x803104
  ...
  801640:	05 24 31 88 00       	add    $0x883124,%eax
  801645:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  80164b:	a1 10 31 80 00       	mov    0x803110,%eax
  801650:	40                   	inc    %eax
  801651:	a3 10 31 80 00       	mov    %eax,0x803110
		ClearNodeData(&(FreeNodes[i]));
  801656:	8b 55 fc             	mov    -0x4(%ebp),%edx
  801659:	89 d0                	mov    %edx,%eax
  80165b:	01 c0                	add    %eax,%eax
  80165d:	01 d0                	add    %edx,%eax
  80165f:	c1 e0 03             	shl    $0x3,%eax
  801662:	05 20 31 88 00       	add    $0x883120,%eax
  801667:	50                   	push   %eax
  801668:	e8 0b ff ff ff       	call   801578 <ClearNodeData>
...
void initialize_buddy()
{
  ...
  801673:	81 7d fc 3f 9c 00 00 	cmpl   $0x9c3f,-0x4(%ebp)
  80167a:	0f 8e 3c ff ff ff    	jle    8015bc <initialize_buddy+0x12>
	{
		LIST_INSERT_HEAD(&BuddyFreeNodesList, &(FreeNodes[i]));
		ClearNodeData(&(FreeNodes[i]));
	}
...
void CreateNewBuddySpace()
{
  ...
  80168c:	68 08 28 80 00       	push   $0x802808
  801691:	6a 22                	push   $0x22
  801693:	68 3a 28 80 00       	push   $0x80283a
  801698:	e8 29 ec ff ff       	call   8002c6 <_panic>

0080169d <FindAllocationUsingBuddy>:
...
void* FindAllocationUsingBuddy(int size)
{
  ...
  8016a6:	68 48 28 80 00       	push   $0x802848
  8016ab:	6a 2a                	push   $0x2a
  8016ad:	68 3a 28 80 00       	push   $0x80283a
  8016b2:	e8 0f ec ff ff       	call   8002c6 <_panic>

008016b7 <FreeAllocationUsingBuddy>:
}
...
void FreeAllocationUsingBuddy(uint32 va)
{
  ...
  8016c0:	68 80 28 80 00       	push   $0x802880
  8016c5:	6a 31                	push   $0x31
  8016c7:	68 3a 28 80 00       	push   $0x80283a
  8016cc:	e8 f5 eb ff ff       	call   8002c6 <_panic>
...
//	cprintf("%s go to sleep...\n", myEnv->prog_name);
  ...
  801d5c:	89 45 f0             	mov    %eax,-0x10(%ebp)
	uint32 cycles_counter =0;
  801d5f:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)

	struct uint64 baseTime = sys_get_virtual_time() ;
  801d66:	8d 45 e8             	lea    -0x18(%ebp),%eax
  801d69:	83 ec 0c             	sub    $0xc,%esp
  801d6c:	50                   	push   %eax
  801d6d:	e8 76 fd ff ff       	call   801ae8 <sys_get_virtual_time>
  801d72:	83 c4 0c             	add    $0xc,%esp
	while(cycles_counter<time_in_cycles)
  801d75:	eb 41                	jmp    801db8 <env_sleep+0x8a>
	{
		struct uint64 currentTime = sys_get_virtual_time() ;
  801d77:	8d 45 e0             	lea    -0x20(%ebp),%eax
  801d7a:	83 ec 0c             	sub    $0xc,%esp
  801d7d:	50                   	push   %eax
  801d7e:	e8 65 fd ff ff       	call   801ae8 <sys_get_virtual_time>
  ...
  801db5:	89 45 f4             	mov    %eax,-0xc(%ebp)
//	cprintf("%s go to sleep...\n", myEnv->prog_name);
	uint32 time_in_cycles=approxMilliSeconds*CYCLES_PER_MILLISEC;
	uint32 cycles_counter =0;
  ...
  801dbb:	3b 45 f0             	cmp    -0x10(%ebp),%eax
  801dbe:	72 b7                	jb     801d77 <env_sleep+0x49>
//				,cycles_counter
//				);
	}
