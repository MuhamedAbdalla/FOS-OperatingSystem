...
void _main(void)
{
  ...
  800041:	e8 fd 1e 00 00       	call   801f43 <sys_disable_interrupt>
  ...
  800158:	e8 00 1e 00 00       	call   801f5d <sys_enable_interrupt>
  ...
  8001ca:	83 c4 10             	add    $0x10,%esp
		...
		sys_disable_interrupt();
  8001cd:	e8 71 1d 00 00       	call   801f43 <sys_disable_interrupt>
  ...
  8001df:	83 c4 10             	add    $0x10,%esp
		...
		sys_enable_interrupt();
  8001e2:	e8 76 1d 00 00       	call   801f5d <sys_enable_interrupt>
  ...
  800210:	e8 e7 06 00 00       	call   8008fc <_panic>
		...
		{
			sys_disable_interrupt();
  800215:	e8 29 1d 00 00       	call   801f43 <sys_disable_interrupt>
			cprintf("===============================================\n") ;
  ...
  800247:	83 c4 10             	add    $0x10,%esp
			sys_enable_interrupt();
  80024a:	e8 0e 1d 00 00       	call   801f5d <sys_enable_interrupt>
		}

		free(Elements) ;
  80024f:	83 ec 0c             	sub    $0xc,%esp
  800252:	ff 75 ec             	pushl  -0x14(%ebp)
  800255:	e8 0b 18 00 00       	call   801a65 <free>
  80025a:	83 c4 10             	add    $0x10,%esp

		sys_disable_interrupt();
  80025d:	e8 e1 1c 00 00       	call   801f43 <sys_disable_interrupt>
			Chose = 0 ;
  ...
  8002b0:	75 b6                	jne    800268 <_main+0x230>
		...
		sys_enable_interrupt();
  8002b2:	e8 a6 1c 00 00       	call   801f5d <sys_enable_interrupt>
...
void PrintElements(int *Elements, int NumOfElements)
{
  ...
  800446:	68 e0 25 80 00       	push   $0x8025e0
  ...
  800467:	50                   	push   %eax
  800468:	68 b8 27 80 00       	push   $0x8027b8
...
void PrintElements(int *Elements, int NumOfElements)
{
  ...
  800495:	50                   	push   %eax
  800496:	68 2f 26 80 00       	push   $0x80262f
...
void Merge(int* A, int p, int q, int r)
{
  ...
  8006fe:	e8 62 13 00 00       	call   801a65 <free>
  800703:	83 c4 10             	add    $0x10,%esp
	free(Right);
  800706:	83 ec 0c             	sub    $0xc,%esp
  800709:	ff 75 d4             	pushl  -0x2c(%ebp)
  80070c:	e8 54 13 00 00       	call   801a65 <free>
...
cputchar(int ch)
{
  ...
  80072a:	50                   	push   %eax
  80072b:	e8 47 18 00 00       	call   801f77 <sys_cputc>
...
atomic_cputchar(int ch)
{
  ...
  800739:	83 ec 18             	sub    $0x18,%esp
	sys_disable_interrupt();
  80073c:	e8 02 18 00 00       	call   801f43 <sys_disable_interrupt>
	char c = ch;
  ...
  80074e:	50                   	push   %eax
  80074f:	e8 23 18 00 00       	call   801f77 <sys_cputc>
  800754:	83 c4 10             	add    $0x10,%esp
	sys_enable_interrupt();
  800757:	e8 01 18 00 00       	call   801f5d <sys_enable_interrupt>
}
  80075c:	90                   	nop
  80075d:	c9                   	leave  
  80075e:	c3                   	ret    
...
getchar(void)
{
  ...
  80076c:	eb 08                	jmp    800776 <getchar+0x17>
	{
		c = sys_cgetc();
  80076e:	e8 e8 15 00 00       	call   801d5b <sys_cgetc>
...
atomic_getchar(void)
{
  ...
  800784:	83 ec 18             	sub    $0x18,%esp
	sys_disable_interrupt();
  800787:	e8 b7 17 00 00       	call   801f43 <sys_disable_interrupt>
	int c=0;
  ...
  800793:	eb 08                	jmp    80079d <atomic_getchar+0x1c>
	{
		c = sys_cgetc();
  800795:	e8 c1 15 00 00       	call   801d5b <sys_cgetc>
...
atomic_getchar(void)
{
  ...
  8007a1:	74 f2                	je     800795 <atomic_getchar+0x14>
	...
	sys_enable_interrupt();
  8007a3:	e8 b5 17 00 00       	call   801f5d <sys_enable_interrupt>
	return c;
...
libmain(int argc, char **argv)
{
  ...
  8007bd:	e8 e6 15 00 00       	call   801da8 <sys_getenvindex>
  ...
  800837:	83 c4 10             	add    $0x10,%esp
	...
	sys_disable_interrupt();
  80083a:	e8 04 17 00 00       	call   801f43 <sys_disable_interrupt>
	cprintf("**************************************\n");
  80083f:	83 ec 0c             	sub    $0xc,%esp
  800842:	68 d8 27 80 00       	push   $0x8027d8
  ...
  800868:	52                   	push   %edx
  800869:	50                   	push   %eax
  80086a:	68 00 28 80 00       	push   $0x802800
  ...
  800890:	52                   	push   %edx
  800891:	50                   	push   %eax
  800892:	68 28 28 80 00       	push   $0x802828
  ...
  8008ad:	50                   	push   %eax
  8008ae:	68 69 28 80 00       	push   $0x802869
  8008b3:	e8 e6 02 00 00       	call   800b9e <cprintf>
  8008b8:	83 c4 10             	add    $0x10,%esp
	cprintf("**************************************\n");
  8008bb:	83 ec 0c             	sub    $0xc,%esp
  8008be:	68 d8 27 80 00       	push   $0x8027d8
  8008c3:	e8 d6 02 00 00       	call   800b9e <cprintf>
  8008c8:	83 c4 10             	add    $0x10,%esp
	sys_enable_interrupt();
  8008cb:	e8 8d 16 00 00       	call   801f5d <sys_enable_interrupt>
...
destroy(void)
{
  ...
  8008e3:	e8 8c 14 00 00       	call   801d74 <sys_env_destroy>
...
exit(void)
{
  ...
  8008f1:	83 ec 08             	sub    $0x8,%esp
	sys_env_exit();
  8008f4:	e8 e1 14 00 00       	call   801dda <sys_env_exit>
}
  8008f9:	90                   	nop
  8008fa:	c9                   	leave  
  8008fb:	c3                   	ret    
...
_panic(const char *file, int line, const char *fmt,...)
{
  ...
  80091c:	50                   	push   %eax
  80091d:	68 80 28 80 00       	push   $0x802880
  ...
  800935:	50                   	push   %eax
  800936:	68 85 28 80 00       	push   $0x802885
  ...
  80095a:	68 a1 28 80 00       	push   $0x8028a1
...
void CheckWSWithoutLastIndex(uint32 *expectedPages, int arraySize)
{
  ...
  800986:	68 a4 28 80 00       	push   $0x8028a4
  80098b:	6a 26                	push   $0x26
  80098d:	68 f0 28 80 00       	push   $0x8028f0
  ...
  800a4c:	68 fc 28 80 00       	push   $0x8028fc
  800a51:	6a 3a                	push   $0x3a
  800a53:	68 f0 28 80 00       	push   $0x8028f0
  ...
  800ab6:	68 50 29 80 00       	push   $0x802950
  800abb:	6a 44                	push   $0x44
  800abd:	68 f0 28 80 00       	push   $0x8028f0
...
static void putch(int ch, struct printbuf *b) {
  ...
  800b0e:	51                   	push   %ecx
  800b0f:	52                   	push   %edx
  800b10:	e8 1d 12 00 00       	call   801d32 <sys_cputs>
...
int vcprintf(const char *fmt, va_list ap) {
  ...
  800b86:	50                   	push   %eax
  800b87:	e8 a6 11 00 00       	call   801d32 <sys_cputs>
...
int atomic_cprintf(const char *fmt, ...) {
  ...
  800bce:	83 ec 18             	sub    $0x18,%esp
	sys_disable_interrupt();
  800bd1:	e8 6d 13 00 00       	call   801f43 <sys_disable_interrupt>
	va_list ap;
	int cnt;
  ...
  800bee:	89 45 f0             	mov    %eax,-0x10(%ebp)
	...
	sys_enable_interrupt();
  800bf1:	e8 67 13 00 00       	call   801f5d <sys_enable_interrupt>
	return cnt;
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800c3b:	e8 24 17 00 00       	call   802364 <__udivdi3>
  ...
  800c89:	52                   	push   %edx
  800c8a:	50                   	push   %eax
  800c8b:	e8 e4 17 00 00       	call   802474 <__umoddi3>
  800c90:	83 c4 10             	add    $0x10,%esp
  800c93:	05 b4 2b 80 00       	add    $0x802bb4,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800de6:	8b 04 85 d8 2b 80 00 	mov    0x802bd8(,%eax,4),%eax
  ...
  800ec7:	8b 34 9d 20 2a 80 00 	mov    0x802a20(,%ebx,4),%esi
  800ece:	85 f6                	test   %esi,%esi
  800ed0:	75 19                	jne    800eeb <vprintfmt+0x173>
				printfmt(putch, putdat, "error %d", err);
  800ed2:	53                   	push   %ebx
  800ed3:	68 c5 2b 80 00       	push   $0x802bc5
  ...
  800ee6:	e9 49 02 00 00       	jmp    801134 <vprintfmt+0x3bc>
			...
			if (err > MAXERROR || (p = error_string[err]) == NULL)
				...
				printfmt(putch, putdat, "%s", p);
  800eeb:	56                   	push   %esi
  800eec:	68 ce 2b 80 00       	push   $0x802bce
  ...
  800f17:	75 05                	jne    800f1e <vprintfmt+0x1a6>
				p = "(null)";
  800f19:	be d1 2b 80 00       	mov    $0x802bd1,%esi
			if (width > 0 && padc != '-')
...
void* malloc(uint32 size)
{
  ...
  801935:	74 0f                	je     801946 <malloc+0x1e>
	{
		initialize_buddy();
  801937:	e8 a4 02 00 00       	call   801be0 <initialize_buddy>
		FirstTimeFlag = 0;
  80193c:	c7 05 04 30 80 00 00 	movl   $0x0,0x803004
  801943:	00 00 00 
	}
	//TODO: [PROJECT 2020 - [2] User Heap] malloc() [User Side]
	// Write your code here, remove the panic and write your code
	if(size > PAGE_SIZE / 2) {
  801946:	81 7d 08 00 08 00 00 	cmpl   $0x800,0x8(%ebp)
  80194d:	0f 86 0b 01 00 00    	jbe    801a5e <malloc+0x136>
		int i = 0, sizeToPage = (size / PAGE_SIZE) + (size % PAGE_SIZE != 0 ? 1 : 0), indx = -1, j = 1;
  801953:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  ...
  80196c:	74 07                	je     801975 <malloc+0x4d>
  80196e:	b8 01 00 00 00       	mov    $0x1,%eax
  801973:	eb 05                	jmp    80197a <malloc+0x52>
  801975:	b8 00 00 00 00       	mov    $0x0,%eax
  80197a:	01 d0                	add    %edx,%eax
  80197c:	89 45 e8             	mov    %eax,-0x18(%ebp)
  80197f:	c7 45 f0 ff ff ff ff 	movl   $0xffffffff,-0x10(%ebp)
  801986:	c7 45 ec 01 00 00 00 	movl   $0x1,-0x14(%ebp)
		for(i = 0; i < MAXN; i++) {
  80198d:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  801994:	eb 5c                	jmp    8019f2 <malloc+0xca>
			if(allocated[i] != 0) continue;
  801996:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801999:	8b 04 85 20 31 80 00 	mov    0x803120(,%eax,4),%eax
  8019a0:	85 c0                	test   %eax,%eax
  8019a2:	75 4a                	jne    8019ee <malloc+0xc6>
			j = 1;
  8019a4:	c7 45 ec 01 00 00 00 	movl   $0x1,-0x14(%ebp)
			i++;
  8019ab:	ff 45 f4             	incl   -0xc(%ebp)
			while(i < MAXN && allocated[i] == 0 && j < sizeToPage) {
  8019ae:	eb 06                	jmp    8019b6 <malloc+0x8e>
				i++;
  8019b0:	ff 45 f4             	incl   -0xc(%ebp)
				j++;
  8019b3:	ff 45 ec             	incl   -0x14(%ebp)
		int i = 0, sizeToPage = (size / PAGE_SIZE) + (size % PAGE_SIZE != 0 ? 1 : 0), indx = -1, j = 1;
		for(i = 0; i < MAXN; i++) {
			if(allocated[i] != 0) continue;
			j = 1;
  ...
  8019b9:	3d ff ff 01 00       	cmp    $0x1ffff,%eax
  8019be:	77 16                	ja     8019d6 <malloc+0xae>
  8019c0:	8b 45 f4             	mov    -0xc(%ebp),%eax
  8019c3:	8b 04 85 20 31 80 00 	mov    0x803120(,%eax,4),%eax
  8019ca:	85 c0                	test   %eax,%eax
  8019cc:	75 08                	jne    8019d6 <malloc+0xae>
  8019ce:	8b 45 ec             	mov    -0x14(%ebp),%eax
  8019d1:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  8019d4:	7c da                	jl     8019b0 <malloc+0x88>
				i++;
				j++;
			}
			if(j == sizeToPage) {
  8019d6:	8b 45 ec             	mov    -0x14(%ebp),%eax
  8019d9:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  8019dc:	75 0b                	jne    8019e9 <malloc+0xc1>
				indx = i - j;
  8019de:	8b 45 f4             	mov    -0xc(%ebp),%eax
  8019e1:	2b 45 ec             	sub    -0x14(%ebp),%eax
  8019e4:	89 45 f0             	mov    %eax,-0x10(%ebp)
				break;
  8019e7:	eb 13                	jmp    8019fc <malloc+0xd4>
			}
			i--;
  8019e9:	ff 4d f4             	decl   -0xc(%ebp)
  8019ec:	eb 01                	jmp    8019ef <malloc+0xc7>
	//TODO: [PROJECT 2020 - [2] User Heap] malloc() [User Side]
	// Write your code here, remove the panic and write your code
	if(size > PAGE_SIZE / 2) {
		int i = 0, sizeToPage = (size / PAGE_SIZE) + (size % PAGE_SIZE != 0 ? 1 : 0), indx = -1, j = 1;
  ...
  8019ee:	90                   	nop
	...
	if(size > PAGE_SIZE / 2) {
		int i = 0, sizeToPage = (size / PAGE_SIZE) + (size % PAGE_SIZE != 0 ? 1 : 0), indx = -1, j = 1;
		for(i = 0; i < MAXN; i++) {
  8019ef:	ff 45 f4             	incl   -0xc(%ebp)
  8019f2:	8b 45 f4             	mov    -0xc(%ebp),%eax
  8019f5:	3d ff ff 01 00       	cmp    $0x1ffff,%eax
  8019fa:	76 9a                	jbe    801996 <malloc+0x6e>
				indx = i - j;
				break;
			}
			i--;
		...
		if(indx == -1) {
  8019fc:	83 7d f0 ff          	cmpl   $0xffffffff,-0x10(%ebp)
  801a00:	75 07                	jne    801a09 <malloc+0xe1>
			return NULL;
  801a02:	b8 00 00 00 00       	mov    $0x0,%eax
  801a07:	eb 5a                	jmp    801a63 <malloc+0x13b>
		}
		i = indx;
  801a09:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801a0c:	89 45 f4             	mov    %eax,-0xc(%ebp)
		while(i < j + indx) {
  801a0f:	eb 13                	jmp    801a24 <malloc+0xfc>
			allocated[i++] = j;
  801a11:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801a14:	8d 50 01             	lea    0x1(%eax),%edx
  801a17:	89 55 f4             	mov    %edx,-0xc(%ebp)
  801a1a:	8b 55 ec             	mov    -0x14(%ebp),%edx
  801a1d:	89 14 85 20 31 80 00 	mov    %edx,0x803120(,%eax,4)
		}
		if(indx == -1) {
			return NULL;
		}
...
void free(void* virtual_address)
{
  ...
  801a79:	89 45 08             	mov    %eax,0x8(%ebp)
  ...
  801a86:	05 00 00 00 80       	add    $0x80000000,%eax
  ...
  801a94:	8b 04 85 20 31 80 00 	mov    0x803120(,%eax,4),%eax
  801a9b:	89 45 e8             	mov    %eax,-0x18(%ebp)
	size = allocated[indx];
  801a9e:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801aa1:	8b 04 85 20 31 80 00 	mov    0x803120(,%eax,4),%eax
  801aa8:	89 45 f4             	mov    %eax,-0xc(%ebp)
	while(size > 0) {
  801aab:	eb 17                	jmp    801ac4 <free+0x5f>
		allocated[indx++] = 0;
  801aad:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801ab0:	8d 50 01             	lea    0x1(%eax),%edx
  801ab3:	89 55 f0             	mov    %edx,-0x10(%ebp)
  801ab6:	c7 04 85 20 31 80 00 	movl   $0x0,0x803120(,%eax,4)
  801abd:	00 00 00 00 
		size--;
  801ac1:	ff 4d f4             	decl   -0xc(%ebp)
	// Write your code here, remove the panic and write your code
	virtual_address = ROUNDDOWN(virtual_address, PAGE_SIZE);
	int size = 0, indx = ((uint32)virtual_address - USER_HEAP_START) / PAGE_SIZE;
	int removable_size = allocated[indx];
  ...
  801ac8:	7f e3                	jg     801aad <free+0x48>
		allocated[indx++] = 0;
		size--;
	}
	sys_freeMem((uint32)virtual_address, removable_size);
  801aca:	8b 55 e8             	mov    -0x18(%ebp),%edx
  801acd:	8b 45 08             	mov    0x8(%ebp),%eax
  801ad0:	83 ec 08             	sub    $0x8,%esp
  801ad3:	52                   	push   %edx
  801ad4:	50                   	push   %eax
  801ad5:	e8 e4 03 00 00       	call   801ebe <sys_freeMem>
...
void *realloc(void *virtual_address, uint32 new_size)
{
  ...
  801ae9:	68 30 2d 80 00       	push   $0x802d30
  801aee:	6a 7a                	push   $0x7a
  801af0:	68 56 2d 80 00       	push   $0x802d56
  801af5:	e8 02 ee ff ff       	call   8008fc <_panic>
...
void* smalloc(char *sharedVarName, uint32 size, uint8 isWritable)
{
  ...
  801b09:	68 64 2d 80 00       	push   $0x802d64
  801b0e:	68 84 00 00 00       	push   $0x84
  801b13:	68 56 2d 80 00       	push   $0x802d56
  801b18:	e8 df ed ff ff       	call   8008fc <_panic>
...
void* sget(int32 ownerEnvID, char *sharedVarName)
{
  ...
  801b26:	68 64 2d 80 00       	push   $0x802d64
  801b2b:	68 8a 00 00 00       	push   $0x8a
  801b30:	68 56 2d 80 00       	push   $0x802d56
  801b35:	e8 c2 ed ff ff       	call   8008fc <_panic>
...
void sfree(void* virtual_address)
{
  ...
  801b43:	68 64 2d 80 00       	push   $0x802d64
  801b48:	68 90 00 00 00       	push   $0x90
  801b4d:	68 56 2d 80 00       	push   $0x802d56
  801b52:	e8 a5 ed ff ff       	call   8008fc <_panic>
...
void expand(uint32 newSize)
{
  ...
  801b60:	68 64 2d 80 00       	push   $0x802d64
  801b65:	68 95 00 00 00       	push   $0x95
  801b6a:	68 56 2d 80 00       	push   $0x802d56
  801b6f:	e8 88 ed ff ff       	call   8008fc <_panic>
...
void shrink(uint32 newSize)
{
  ...
  801b7d:	68 64 2d 80 00       	push   $0x802d64
  801b82:	68 99 00 00 00       	push   $0x99
  801b87:	68 56 2d 80 00       	push   $0x802d56
  801b8c:	e8 6b ed ff ff       	call   8008fc <_panic>
...
void freeHeap(void* virtual_address)
{
  ...
  801b9a:	68 64 2d 80 00       	push   $0x802d64
  801b9f:	68 9e 00 00 00       	push   $0x9e
  801ba4:	68 56 2d 80 00       	push   $0x802d56
  801ba9:	e8 4e ed ff ff       	call   8008fc <_panic>

00801bae <ClearNodeData>:
...
void ClearNodeData(struct BuddyNode* node)
{
  ...
  801bb4:	c6 40 11 00          	movb   $0x0,0x11(%eax)
	node->status = FREE;
  801bb8:	8b 45 08             	mov    0x8(%ebp),%eax
  801bbb:	c6 40 10 00          	movb   $0x0,0x10(%eax)
	node->va = 0;
  801bbf:	8b 45 08             	mov    0x8(%ebp),%eax
  801bc2:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
	node->parent = NULL;
  801bc9:	8b 45 08             	mov    0x8(%ebp),%eax
  801bcc:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
	node->myBuddy = NULL;
  801bd3:	8b 45 08             	mov    0x8(%ebp),%eax
  801bd6:	c7 40 14 00 00 00 00 	movl   $0x0,0x14(%eax)
}
  801bdd:	90                   	nop
  801bde:	5d                   	pop    %ebp
  801bdf:	c3                   	ret    

00801be0 <initialize_buddy>:
...
void initialize_buddy()
{
  ...
  801bed:	e9 b7 00 00 00       	jmp    801ca9 <initialize_buddy+0xc9>
	{
		LIST_INSERT_HEAD(&BuddyFreeNodesList, &(FreeNodes[i]));
  801bf2:	8b 15 04 31 80 00    	mov    0x803104,%edx
  801bf8:	8b 4d fc             	mov    -0x4(%ebp),%ecx
  801bfb:	89 c8                	mov    %ecx,%eax
  801bfd:	01 c0                	add    %eax,%eax
  801bff:	01 c8                	add    %ecx,%eax
  801c01:	c1 e0 03             	shl    $0x3,%eax
  801c04:	05 20 31 88 00       	add    $0x883120,%eax
  801c09:	89 10                	mov    %edx,(%eax)
  801c0b:	8b 55 fc             	mov    -0x4(%ebp),%edx
  801c0e:	89 d0                	mov    %edx,%eax
  801c10:	01 c0                	add    %eax,%eax
  801c12:	01 d0                	add    %edx,%eax
  801c14:	c1 e0 03             	shl    $0x3,%eax
  801c17:	05 20 31 88 00       	add    $0x883120,%eax
  801c1c:	8b 00                	mov    (%eax),%eax
  801c1e:	85 c0                	test   %eax,%eax
  801c20:	74 1c                	je     801c3e <initialize_buddy+0x5e>
  801c22:	8b 15 04 31 80 00    	mov    0x803104,%edx
  801c28:	8b 4d fc             	mov    -0x4(%ebp),%ecx
  801c2b:	89 c8                	mov    %ecx,%eax
  801c2d:	01 c0                	add    %eax,%eax
  801c2f:	01 c8                	add    %ecx,%eax
  801c31:	c1 e0 03             	shl    $0x3,%eax
  801c34:	05 20 31 88 00       	add    $0x883120,%eax
  801c39:	89 42 04             	mov    %eax,0x4(%edx)
  801c3c:	eb 16                	jmp    801c54 <initialize_buddy+0x74>
  801c3e:	8b 55 fc             	mov    -0x4(%ebp),%edx
  801c41:	89 d0                	mov    %edx,%eax
  801c43:	01 c0                	add    %eax,%eax
  801c45:	01 d0                	add    %edx,%eax
  801c47:	c1 e0 03             	shl    $0x3,%eax
  801c4a:	05 20 31 88 00       	add    $0x883120,%eax
  801c4f:	a3 08 31 80 00       	mov    %eax,0x803108
  801c54:	8b 55 fc             	mov    -0x4(%ebp),%edx
  801c57:	89 d0                	mov    %edx,%eax
  801c59:	01 c0                	add    %eax,%eax
  801c5b:	01 d0                	add    %edx,%eax
  801c5d:	c1 e0 03             	shl    $0x3,%eax
  801c60:	05 20 31 88 00       	add    $0x883120,%eax
  801c65:	a3 04 31 80 00       	mov    %eax,0x803104
  ...
  801c76:	05 24 31 88 00       	add    $0x883124,%eax
  801c7b:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  801c81:	a1 10 31 80 00       	mov    0x803110,%eax
  801c86:	40                   	inc    %eax
  801c87:	a3 10 31 80 00       	mov    %eax,0x803110
  ...
  801c9d:	50                   	push   %eax
  801c9e:	e8 0b ff ff ff       	call   801bae <ClearNodeData>
...
{
	for (int i = 0; i < BUDDY_NUM_FREE_NODES; ++i)
  801ca6:	ff 45 fc             	incl   -0x4(%ebp)
  801ca9:	81 7d fc 3f 9c 00 00 	cmpl   $0x9c3f,-0x4(%ebp)
  801cb0:	0f 8e 3c ff ff ff    	jle    801bf2 <initialize_buddy+0x12>
	{
		LIST_INSERT_HEAD(&BuddyFreeNodesList, &(FreeNodes[i]));
		ClearNodeData(&(FreeNodes[i]));
	}
...
void CreateNewBuddySpace()
{
  ...
  801cc2:	68 88 2d 80 00       	push   $0x802d88
  801cc7:	6a 22                	push   $0x22
  801cc9:	68 ba 2d 80 00       	push   $0x802dba
  801cce:	e8 29 ec ff ff       	call   8008fc <_panic>

00801cd3 <FindAllocationUsingBuddy>:
...
void* FindAllocationUsingBuddy(int size)
{
  ...
  801cdc:	68 c8 2d 80 00       	push   $0x802dc8
  801ce1:	6a 2a                	push   $0x2a
  801ce3:	68 ba 2d 80 00       	push   $0x802dba
  801ce8:	e8 0f ec ff ff       	call   8008fc <_panic>

00801ced <FreeAllocationUsingBuddy>:
}
...
void FreeAllocationUsingBuddy(uint32 va)
{
  ...
  801cf6:	68 00 2e 80 00       	push   $0x802e00
  801cfb:	6a 31                	push   $0x31
  801cfd:	68 ba 2d 80 00       	push   $0x802dba
  801d02:	e8 f5 eb ff ff       	call   8008fc <_panic>
...
int sys_env_destroy(int32  envid)
{
  ...
  801d82:	50                   	push   %eax
  801d83:	6a 05                	push   $0x5
  801d85:	e8 7d ff ff ff       	call   801d07 <syscall>
  801d8a:	83 c4 18             	add    $0x18,%esp
}
  801d8d:	c9                   	leave  
  801d8e:	c3                   	ret    

00801d8f <sys_getenvid>:
...
int32 sys_getenvid(void)
{
  ...
  801d9c:	6a 02                	push   $0x2
  801d9e:	e8 64 ff ff ff       	call   801d07 <syscall>
  801da3:	83 c4 18             	add    $0x18,%esp
}
  801da6:	c9                   	leave  
  801da7:	c3                   	ret    

00801da8 <sys_getenvindex>:
...
int32 sys_getenvindex(void)
{
  ...
  801db5:	6a 03                	push   $0x3
  801db7:	e8 4b ff ff ff       	call   801d07 <syscall>
  801dbc:	83 c4 18             	add    $0x18,%esp
}
  801dbf:	c9                   	leave  
  801dc0:	c3                   	ret    

00801dc1 <sys_getparentenvid>:
...
int32 sys_getparentenvid(void)
{
  ...
  801dce:	6a 04                	push   $0x4
  801dd0:	e8 32 ff ff ff       	call   801d07 <syscall>
  801dd5:	83 c4 18             	add    $0x18,%esp
}
  801dd8:	c9                   	leave  
  801dd9:	c3                   	ret    

00801dda <sys_env_exit>:
...
int __sys_allocate_page(void *va, int perm)
{
  ...
  801e03:	52                   	push   %edx
  801e04:	50                   	push   %eax
  801e05:	6a 07                	push   $0x7
  801e07:	e8 fb fe ff ff       	call   801d07 <syscall>
  801e0c:	83 c4 18             	add    $0x18,%esp
}
  801e0f:	c9                   	leave  
  801e10:	c3                   	ret    

00801e11 <__sys_map_frame>:
...
int __sys_map_frame(int32 srcenv, void *srcva, int32 dstenv, void *dstva, int perm)
{
  ...
  801e16:	8b 75 18             	mov    0x18(%ebp),%esi
  ...
  801e28:	52                   	push   %edx
  801e29:	50                   	push   %eax
  801e2a:	6a 08                	push   $0x8
  801e2c:	e8 d6 fe ff ff       	call   801d07 <syscall>
...
int __sys_unmap_frame(int32 envid, void *va)
{
  ...
  801e4a:	52                   	push   %edx
  801e4b:	50                   	push   %eax
  801e4c:	6a 09                	push   $0x9
  801e4e:	e8 b4 fe ff ff       	call   801d07 <syscall>
  801e53:	83 c4 18             	add    $0x18,%esp
}
  801e56:	c9                   	leave  
  801e57:	c3                   	ret    

00801e58 <sys_calculate_required_frames>:
...
uint32 sys_calculate_required_frames(uint32 start_virtual_address, uint32 size)
{
  ...
  801e67:	6a 0a                	push   $0xa
  801e69:	e8 99 fe ff ff       	call   801d07 <syscall>
  801e6e:	83 c4 18             	add    $0x18,%esp
}
  801e71:	c9                   	leave  
  801e72:	c3                   	ret    

00801e73 <sys_calculate_free_frames>:
...
uint32 sys_calculate_free_frames()
{
  ...
  801e82:	e8 80 fe ff ff       	call   801d07 <syscall>
  801e87:	83 c4 18             	add    $0x18,%esp
}
  801e8a:	c9                   	leave  
  801e8b:	c3                   	ret    

00801e8c <sys_calculate_modified_frames>:
uint32 sys_calculate_modified_frames()
{
  ...
  801e9b:	e8 67 fe ff ff       	call   801d07 <syscall>
  801ea0:	83 c4 18             	add    $0x18,%esp
}
  801ea3:	c9                   	leave  
  801ea4:	c3                   	ret    

00801ea5 <sys_calculate_notmod_frames>:
...
uint32 sys_calculate_notmod_frames()
{
  ...
  801eb4:	e8 4e fe ff ff       	call   801d07 <syscall>
  801eb9:	83 c4 18             	add    $0x18,%esp
}
  801ebc:	c9                   	leave  
  801ebd:	c3                   	ret    

00801ebe <sys_freeMem>:
...
void sys_freeMem(uint32 virtual_address, uint32 size)
{
  ...
  801ecd:	6a 11                	push   $0x11
  801ecf:	e8 33 fe ff ff       	call   801d07 <syscall>
...
void sys_allocateMem(uint32 virtual_address, uint32 size)
{
  ...
  801eeb:	e8 17 fe ff ff       	call   801d07 <syscall>
...
00801ef6 <sys_pf_calculate_allocated_pages>:
...
int sys_pf_calculate_allocated_pages()
{
  ...
  801f03:	6a 0e                	push   $0xe
  801f05:	e8 fd fd ff ff       	call   801d07 <syscall>
  801f0a:	83 c4 18             	add    $0x18,%esp
}
  801f0d:	c9                   	leave  
  801f0e:	c3                   	ret    

00801f0f <sys_calculate_pages_tobe_removed_ready_exit>:
...
int sys_calculate_pages_tobe_removed_ready_exit(uint32 WS_or_MEMORY_flag)
{
  ...
  801f1d:	6a 0f                	push   $0xf
  801f1f:	e8 e3 fd ff ff       	call   801d07 <syscall>
  801f24:	83 c4 18             	add    $0x18,%esp
}
  801f27:	c9                   	leave  
  801f28:	c3                   	ret    

00801f29 <sys_scarce_memory>:
...
void sys_scarce_memory()
{
  ...
  801f36:	6a 10                	push   $0x10
  801f38:	e8 ca fd ff ff       	call   801d07 <syscall>
...
00801f43 <sys_disable_interrupt>:
...
sys_disable_interrupt()
{
  ...
  801f50:	6a 14                	push   $0x14
  801f52:	e8 b0 fd ff ff       	call   801d07 <syscall>
...
sys_enable_interrupt()
{
  ...
  801f6a:	6a 15                	push   $0x15
  801f6c:	e8 96 fd ff ff       	call   801d07 <syscall>
...
sys_cputc(const char c)
{
  ...
  801f80:	88 45 fc             	mov    %al,-0x4(%ebp)
  ...
  801f8f:	50                   	push   %eax
  801f90:	6a 16                	push   $0x16
  801f92:	e8 70 fd ff ff       	call   801d07 <syscall>
...
sys_clear_ffl()
{
  ...
  801faa:	6a 17                	push   $0x17
  801fac:	e8 56 fd ff ff       	call   801d07 <syscall>
...
sys_createSemaphore(char* semaphoreName, uint32 initialValue)
{
  ...
  801fc6:	50                   	push   %eax
  801fc7:	6a 18                	push   $0x18
  801fc9:	e8 39 fd ff ff       	call   801d07 <syscall>
  801fce:	83 c4 18             	add    $0x18,%esp
}
  801fd1:	c9                   	leave  
  801fd2:	c3                   	ret    

00801fd3 <sys_getSemaphoreValue>:
...
sys_getSemaphoreValue(int32 ownerEnvID, char* semaphoreName)
{
  ...
  801fe6:	e8 1c fd ff ff       	call   801d07 <syscall>
  801feb:	83 c4 18             	add    $0x18,%esp
}
  801fee:	c9                   	leave  
  801fef:	c3                   	ret    

00801ff0 <sys_waitSemaphore>:
...
sys_waitSemaphore(int32 ownerEnvID, char* semaphoreName)
{
  ...
  801fff:	52                   	push   %edx
  802000:	50                   	push   %eax
  802001:	6a 19                	push   $0x19
  802003:	e8 ff fc ff ff       	call   801d07 <syscall>
...
sys_signalSemaphore(int32 ownerEnvID, char* semaphoreName)
{
  ...
  802021:	e8 e1 fc ff ff       	call   801d07 <syscall>
...
0080202c <sys_createSharedObject>:
...
sys_createSharedObject(char* shareName, uint32 size, uint8 isWritable, void* virtual_address)
{
  ...
  802038:	8b 4d 14             	mov    0x14(%ebp),%ecx
  80203b:	0f b6 55 fc          	movzbl -0x4(%ebp),%edx
  ...
  802049:	50                   	push   %eax
  80204a:	6a 1c                	push   $0x1c
  80204c:	e8 b6 fc ff ff       	call   801d07 <syscall>
  802051:	83 c4 18             	add    $0x18,%esp
}
  802054:	c9                   	leave  
  802055:	c3                   	ret    

00802056 <sys_getSizeOfSharedObject>:
...
sys_getSizeOfSharedObject(int32 ownerID, char* shareName)
{
  ...
  802065:	52                   	push   %edx
  802066:	50                   	push   %eax
  802067:	6a 1d                	push   $0x1d
  802069:	e8 99 fc ff ff       	call   801d07 <syscall>
  80206e:	83 c4 18             	add    $0x18,%esp
}
  802071:	c9                   	leave  
  802072:	c3                   	ret    

00802073 <sys_getSharedObject>:
//==========
...
sys_getSharedObject(int32 ownerID, char* shareName, void* virtual_address)
{
  ...
  802084:	52                   	push   %edx
  802085:	50                   	push   %eax
  802086:	6a 1e                	push   $0x1e
  802088:	e8 7a fc ff ff       	call   801d07 <syscall>
  80208d:	83 c4 18             	add    $0x18,%esp
}
  802090:	c9                   	leave  
  802091:	c3                   	ret    

00802092 <sys_freeSharedObject>:
...
sys_freeSharedObject(int32 sharedObjectID, void *startVA)
{
  ...
  8020a5:	e8 5d fc ff ff       	call   801d07 <syscall>
  8020aa:	83 c4 18             	add    $0x18,%esp
}
  8020ad:	c9                   	leave  
  8020ae:	c3                   	ret    

008020af <sys_getMaxShares>:
...
uint32 	sys_getMaxShares()
{
  ...
  8020bc:	6a 20                	push   $0x20
  8020be:	e8 44 fc ff ff       	call   801d07 <syscall>
  8020c3:	83 c4 18             	add    $0x18,%esp
}
  8020c6:	c9                   	leave  
  8020c7:	c3                   	ret    

008020c8 <sys_create_env>:
...
int sys_create_env(char* programName, unsigned int page_WS_size,unsigned int LRU_second_list_size,unsigned int percent_WS_pages_to_remove)
{
  ...
  8020d0:	ff 75 14             	pushl  0x14(%ebp)
  8020d3:	ff 75 10             	pushl  0x10(%ebp)
  8020d6:	ff 75 0c             	pushl  0xc(%ebp)
  8020d9:	50                   	push   %eax
  8020da:	6a 21                	push   $0x21
  8020dc:	e8 26 fc ff ff       	call   801d07 <syscall>
  8020e1:	83 c4 18             	add    $0x18,%esp
}
  8020e4:	c9                   	leave  
  8020e5:	c3                   	ret    

008020e6 <sys_run_env>:
...
sys_run_env(int32 envId)
{
  ...
  8020f4:	50                   	push   %eax
  8020f5:	6a 22                	push   $0x22
  8020f7:	e8 0b fc ff ff       	call   801d07 <syscall>
...
sys_free_env(int32 envId)
{
  ...
  802110:	50                   	push   %eax
  802111:	6a 23                	push   $0x23
  802113:	e8 ef fb ff ff       	call   801d07 <syscall>
...
sys_get_virtual_time()
{
  ...
  802124:	8d 45 f8             	lea    -0x8(%ebp),%eax
  802127:	8d 50 04             	lea    0x4(%eax),%edx
  ...
  802133:	52                   	push   %edx
  802134:	50                   	push   %eax
  802135:	6a 24                	push   $0x24
  802137:	e8 cb fb ff ff       	call   801d07 <syscall>
  80213c:	83 c4 18             	add    $0x18,%esp
	return result;
  80213f:	8b 4d 08             	mov    0x8(%ebp),%ecx
  802142:	8b 45 f8             	mov    -0x8(%ebp),%eax
  802145:	8b 55 fc             	mov    -0x4(%ebp),%edx
  802148:	89 01                	mov    %eax,(%ecx)
  80214a:	89 51 04             	mov    %edx,0x4(%ecx)
}
  80214d:	8b 45 08             	mov    0x8(%ebp),%eax
  802150:	c9                   	leave  
  802151:	c2 04 00             	ret    $0x4

00802154 <sys_moveMem>:
...
void sys_moveMem(uint32 src_virtual_address, uint32 dst_virtual_address, uint32 size)
{
  ...
  802164:	6a 13                	push   $0x13
  802166:	e8 9c fb ff ff       	call   801d07 <syscall>
...
uint32 sys_rcr2()
{
  ...
  802180:	e8 82 fb ff ff       	call   801d07 <syscall>
  802185:	83 c4 18             	add    $0x18,%esp
}
  802188:	c9                   	leave  
  802189:	c3                   	ret    

0080218a <sys_bypassPageFault>:
void sys_bypassPageFault(uint8 instrLength)
{
  ...
  802196:	0f b6 45 fc          	movzbl -0x4(%ebp),%eax
  80219a:	6a 00                	push   $0x0
  80219c:	6a 00                	push   $0x0
  80219e:	6a 00                	push   $0x0
  8021a0:	6a 00                	push   $0x0
  8021a2:	50                   	push   %eax
  8021a3:	6a 26                	push   $0x26
  8021a5:	e8 5d fb ff ff       	call   801d07 <syscall>
...
void rsttst()
{
  ...
  8021bd:	6a 28                	push   $0x28
  8021bf:	e8 43 fb ff ff       	call   801d07 <syscall>
...
void tst(uint32 n, uint32 v1, uint32 v2, char c, int inv)
{
  ...
  8021d0:	8b 45 14             	mov    0x14(%ebp),%eax
  8021d3:	88 45 fc             	mov    %al,-0x4(%ebp)
	syscall(SYS_testNum, n, v1, v2, c, inv);
  8021d6:	8b 55 18             	mov    0x18(%ebp),%edx
  ...
  8021e8:	6a 27                	push   $0x27
  8021ea:	e8 18 fb ff ff       	call   801d07 <syscall>
...
void chktst(uint32 n)
{
  ...
  802205:	e8 fd fa ff ff       	call   801d07 <syscall>
...
void inctst()
{
  ...
  80221d:	6a 2a                	push   $0x2a
  80221f:	e8 e3 fa ff ff       	call   801d07 <syscall>
...
uint32 gettst()
{
  ...
  802237:	6a 2b                	push   $0x2b
  802239:	e8 c9 fa ff ff       	call   801d07 <syscall>
  80223e:	83 c4 18             	add    $0x18,%esp
}
  802241:	c9                   	leave  
  802242:	c3                   	ret    

00802243 <sys_isUHeapPlacementStrategyFIRSTFIT>:
...
uint32 sys_isUHeapPlacementStrategyFIRSTFIT()
{
  ...
  802255:	e8 ad fa ff ff       	call   801d07 <syscall>
  80225a:	83 c4 18             	add    $0x18,%esp
  80225d:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_FIRSTFIT)
  802260:	83 7d fc 01          	cmpl   $0x1,-0x4(%ebp)
  802264:	75 07                	jne    80226d <sys_isUHeapPlacementStrategyFIRSTFIT+0x2a>
		return 1;
  802266:	b8 01 00 00 00       	mov    $0x1,%eax
  80226b:	eb 05                	jmp    802272 <sys_isUHeapPlacementStrategyFIRSTFIT+0x2f>
	else
		return 0;
...
00802274 <sys_isUHeapPlacementStrategyBESTFIT>:
uint32 sys_isUHeapPlacementStrategyBESTFIT()
{
  ...
  802286:	e8 7c fa ff ff       	call   801d07 <syscall>
  80228b:	83 c4 18             	add    $0x18,%esp
  80228e:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_BESTFIT)
  802291:	83 7d fc 02          	cmpl   $0x2,-0x4(%ebp)
  802295:	75 07                	jne    80229e <sys_isUHeapPlacementStrategyBESTFIT+0x2a>
		return 1;
  802297:	b8 01 00 00 00       	mov    $0x1,%eax
  80229c:	eb 05                	jmp    8022a3 <sys_isUHeapPlacementStrategyBESTFIT+0x2f>
	else
		return 0;
...
008022a5 <sys_isUHeapPlacementStrategyNEXTFIT>:
uint32 sys_isUHeapPlacementStrategyNEXTFIT()
{
  ...
  8022b7:	e8 4b fa ff ff       	call   801d07 <syscall>
  8022bc:	83 c4 18             	add    $0x18,%esp
  8022bf:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_NEXTFIT)
  8022c2:	83 7d fc 03          	cmpl   $0x3,-0x4(%ebp)
  8022c6:	75 07                	jne    8022cf <sys_isUHeapPlacementStrategyNEXTFIT+0x2a>
		return 1;
  8022c8:	b8 01 00 00 00       	mov    $0x1,%eax
  8022cd:	eb 05                	jmp    8022d4 <sys_isUHeapPlacementStrategyNEXTFIT+0x2f>
	else
		return 0;
...
008022d6 <sys_isUHeapPlacementStrategyWORSTFIT>:
uint32 sys_isUHeapPlacementStrategyWORSTFIT()
{
  ...
  8022e8:	e8 1a fa ff ff       	call   801d07 <syscall>
  8022ed:	83 c4 18             	add    $0x18,%esp
  8022f0:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_WORSTFIT)
  8022f3:	83 7d fc 04          	cmpl   $0x4,-0x4(%ebp)
  8022f7:	75 07                	jne    802300 <sys_isUHeapPlacementStrategyWORSTFIT+0x2a>
		return 1;
  8022f9:	b8 01 00 00 00       	mov    $0x1,%eax
  8022fe:	eb 05                	jmp    802305 <sys_isUHeapPlacementStrategyWORSTFIT+0x2f>
	else
		return 0;
...
00802307 <sys_set_uheap_strategy>:
...
void sys_set_uheap_strategy(uint32 heapStrategy)
{
  ...
  802315:	6a 2d                	push   $0x2d
  802317:	e8 eb f9 ff ff       	call   801d07 <syscall>
...
int sys_check_LRU_lists(uint32* active_list_content, uint32* second_list_content, int actual_active_list_size, int actual_second_list_size)
{
  ...
  802336:	52                   	push   %edx
  802337:	50                   	push   %eax
  802338:	6a 2e                	push   $0x2e
  80233a:	e8 c8 f9 ff ff       	call   801d07 <syscall>
  80233f:	83 c4 18             	add    $0x18,%esp
}
  802342:	8b 5d fc             	mov    -0x4(%ebp),%ebx
  802345:	c9                   	leave  
  802346:	c3                   	ret    

00802347 <sys_check_LRU_lists_free>:
...
int sys_check_LRU_lists_free(uint32* list_content, int list_size)
{
  ...
  802356:	52                   	push   %edx
  802357:	50                   	push   %eax
  802358:	6a 2f                	push   $0x2f
  80235a:	e8 a8 f9 ff ff       	call   801d07 <syscall>
